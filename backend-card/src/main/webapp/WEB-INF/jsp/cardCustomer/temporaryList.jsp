    ...
    <div class="row" id="searchTools">
        <div class="col-md-12">
            <form class="form-inline">
                ...
                <div class="form-group" style="margin-right: 50px;">
                    <label for="endDate">卡号：</label>
                    <input type="text" class="form-control" id="telephone" v-model="searchDate.telephone"  placeholder="请输入卡号">
                </div>
                ...
                <div class="modal-body">
                    <ul class="list-style">
                        ...
                        <li>当前类型:
                            ...
                            <span v-if="platformOrderk.type == 2">临时卡</span>
