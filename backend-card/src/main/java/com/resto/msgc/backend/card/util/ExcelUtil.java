        ...
        for(int i=0;i<4;i++){
			...
			case 3:
			    if(map.get("beginDate")!=null && map.get("endDate")!=null){
                    ...
                    cell.setCellValue(new HSSFRichTextString("统计时间："+map.get("mothDate")+"月份"));
                }
...
//       
    ...
    public void ExportShopMothExcel(HSSFWorkbook workbook,String[][] headers , String[] columns, Collection<T> result, Map<String, String>map) throws Exception {
        ...
        for(int i=0;i<4;i++){
            ...
            switch (i) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    if(map.get("shops")!=null){
                        cell.setCellValue(new HSSFRichTextString("店铺:"+map.get("shops")));
                        // 指定合并区域
                        sheet.addMergedRegion(new CellRangeAddress(2,(short)2,0,(short)num));
                    }
                    if(map.get("companyName")!=null){
                        cell.setCellValue(new HSSFRichTextString("公司:"+map.get("companyName")));
                        // 指定合并区域
                        sheet.addMergedRegion(new CellRangeAddress(2,(short)2,0,(short)num));
                    }
...
//
    ...
    public void ExportCardExcel(String fileName,HttpServletRequest request,HttpServletResponse response,HSSFWorkbook workbook, String[][] headers , String[] columns, Collection<Object> result, Map<String, String>map) throws Exception {
...
//
    ...
    public void ExportCardMothExcel(String fileName,HttpServletRequest request,HttpServletResponse response,HSSFWorkbook workbook, String[][] headers , String[] columns, Collection<Object> result, Map<String, String>map) throws Exception {
