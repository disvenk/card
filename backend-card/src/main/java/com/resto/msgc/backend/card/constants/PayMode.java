...
public class PayMode {
	...
	public static final int ACCOUNT_PAY =2;  //红包支付 zhe
	public static final int COUPON_PAY=3;    //优惠券支付 zhe
	...
	public static final int REWARD_PAY = 7; //充值赠送的金额支付 zhe
    public static final int WAIT_MONEY = 8; //等位红包 zhe
    ...
    public static final int APPRAISE_RED_PAY = 13; //评论红包支付 zhe
    public static final int SHARE_RED_PAY = 14; //分享返利红包支付 zhe
    public static final int REFUND_ARTICLE_RED_PAY = 15; //退菜红包支付 zhe
    public static final int SHANHUI_PAY = 16; //闪惠支付  大众点评
    public static final int INTEGRAL_PAY = 17; //会员积分支付 zhe
    ...
    public static final int REBATE_MONEY_RED_PAY = 21; //消费返利余额支付 zhe
    public static final int CARD_DISCOUNT_PAY = 22; //储值卡折扣支付
    public static final int CARD_CHARGE_PAY = 23; //卡充值金额支付
    public static final int CARD_REWARD_PAY = 24; //卡充值赠送金额支付 zhe
    public static final int CARD_REFUND_PAY = 25; //退菜退款到充值卡
